...
async fn main() -> anyhow::Result<()> {
    ...
    let chrome_path = "/nix/store/b8w6xj2isq4m120sz2gg4hb5gxhjmzca-chromium-143.0.7499.40/bin/chromium";
    ...
    println!("Browser initialized in {:.2}s", start.elapsed().as_secs_f64());
...
fn main() {
    ...
    eprintln!("Please run with: cargo run --example hacker_news_titles --features chromiumoxide-backend");
    std::process::exit(1);
}
