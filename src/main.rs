...
use web_spec::cli::{args::{Args, Commands}, commands, output::{format_output, write_output}};
...
fn build_step_registry() -> StepRegistry {
    ...
    // Element waiting
    registry.register(r#"I wait for element "([^"]+)" to be visible"#, "wait_visible");
    ...
    // Advanced waiting
    registry.register(r#"I wait for element "([^"]+)" to be hidden"#, "wait_hidden");
    registry.register(r#"I wait for "([^"]+)" to disappear"#, "wait_hidden");
    registry.register(r#"I wait for text "([^"]+)" to appear"#, "wait_for_text");
    registry.register(r#"I wait for element "([^"]+)" to contain "([^"]+)""#, "wait_for_element_text");
    registry.register(r#"I wait for element "([^"]+)" to be (?:clickable|enabled)"#, "wait_clickable");
    ...
    registry.register(r#"I click the "([^"]+)" (button|link)"#, "click_button_or_link");
    ...
    registry.register(r#"I click the right mouse button on "([^"]+)""#, "right_click");
    ...
    registry.register(r#"I drag element "([^"]+)" and drop it on "([^"]+)""#, "drag_and_drop");
    ...
    registry.register(r#"I select the "([^"]+)" radio (?:button|option)"#, "select_radio");
    
    // Multi-select
    registry.register(r#"I select "([^"]+)", "([^"]+)", and "([^"]+)" from "([^"]+)""#, "select_multiple");
    ...
    registry.register(r"I scroll (\d+) pixels? (down|up)", "scroll_pixels_vertical");
    registry.register(r"I scroll (\d+) pixels? (left|right)", "scroll_pixels_horizontal");
    ...
    registry.register(r#"I should not see the element "([^"]+)""#, "should_not_see");
    registry.register(r#"the element "([^"]+)" should be visible"#, "should_be_visible");
    registry.register(r#"the element "([^"]+)" should not be visible"#, "should_not_be_visible");
    registry.register(r#""([^"]+)" should be visible"#, "should_be_visible");
    registry.register(r#""([^"]+)" should not be visible"#, "should_not_be_visible");
    
    // Element state
    registry.register(r#"the element "([^"]+)" should exist"#, "should_exist");
    registry.register(r#"the element "([^"]+)" should not exist"#, "should_not_exist");
    registry.register(r#"the element "([^"]+)" should be enabled"#, "should_be_enabled");
    registry.register(r#"the element "([^"]+)" should be disabled"#, "should_be_disabled");
    registry.register(r#"the element "([^"]+)" should be checked"#, "should_be_checked");
    registry.register(r#"the element "([^"]+)" should not be checked"#, "should_not_be_checked");
    registry.register(r#"the element "([^"]+)" should be selected"#, "should_be_selected");
    registry.register(r#"the element "([^"]+)" should be focused"#, "should_be_focused");
    registry.register(r#"the element "([^"]+)" should contain "([^"]+)""#, "should_contain_text");
    registry.register(r#"the element "([^"]+)" should not contain "([^"]+)""#, "should_not_contain_text");
    
    // ===== COUNTING PATTERNS =====
    registry.register(r"I should see at least (\d+) ([^ ]+)", "should_see_min_count");
    registry.register(r"I should see minimum (\d+) ([^ ]+)", "should_see_min_count");
    registry.register(r"I should see at most (\d+) ([^ ]+)", "should_see_max_count");
    registry.register(r"I should see exactly (\d+) ([^ ]+)", "should_see_exact_count");
    registry.register(r"I should see exactly (\d+) ([^ ]+) elements?", "should_see_exact_count");
    registry.register(r"there should be (\d+) ([^ ]+)", "should_see_exact_count");
    registry.register(r#"there should be (\d+) "([^"]+)""#, "should_see_exact_count_elements");
    ...
    registry.register(r#"the page should not contain "([^"]+)""#, "should_not_see_text");
    registry.register(r#"the text of "([^"]+)" should be "([^"]+)""#, "text_should_be");
    registry.register(r#"the text of "([^"]+)" should contain "([^"]+)""#, "text_should_contain");
    registry.register(r#"the text of "([^"]+)" should equal "([^"]+)""#, "text_should_be");
    registry.register(r#"the text of "([^"]+)" should match "([^"]+)""#, "text_should_match");
    registry.register(r#"the text of "([^"]+)" should start with "([^"]+)""#, "text_should_start");
    registry.register(r#"the text of "([^"]+)" should end with "([^"]+)""#, "text_should_end");
    
    // ===== ATTRIBUTE PATTERNS =====
    registry.register(r#"the "([^"]+)" attribute of "([^"]+)" should be "([^"]+)""#, "attribute_should_be");
    registry.register(r#"the "([^"]+)" attribute of "([^"]+)" should contain "([^"]+)""#, "attribute_should_contain");
    registry.register(r#"the "([^"]+)" attribute of "([^"]+)" should exist"#, "attribute_should_exist");
    registry.register(r#"the element "([^"]+)" should have "([^"]+)" attribute"#, "attribute_should_exist");
    registry.register(r#"the element "([^"]+)" should have "([^"]+)" attribute set to "([^"]+)""#, "attribute_should_be");
    
    // ===== CSS PATTERNS =====
    registry.register(r#"the "([^"]+)" CSS property of "([^"]+)" should be "([^"]+)""#, "css_should_be");
    registry.register(r#"the element "([^"]+)" should have "([^"]+)" CSS value of "([^"]+)""#, "css_should_be");
    registry.register(r#"the element "([^"]+)" should have color "([^"]+)""#, "color_should_be");
    registry.register(r#"the element "([^"]+)" should have background "([^"]+)""#, "background_should_be");
    ...
    registry.register(r#"the path should contain "([^"]+)""#, "path_should_contain");
    registry.register(r#"the title should be "([^"]+)""#, "title_should_be");
    registry.register(r#"the title should contain "([^"]+)""#, "title_should_contain");
    ...
    registry.register(r#"the value "([^"]+)" should be "([^"]+)""#, "value_should_be");
    ...
    registry.register(r#"the alert text should be "([^"]+)""#, "alert_text_should_be");
    ...
    registry.register(r#"I extract text from "([^"]+)""#, "extract_text_from_element");
    registry.register(r#"I extract "([^"]+)" from "([^"]+)""#, "extract_attribute_from_element");
    registry.register(r#"I extract the "([^"]+)" attribute from "([^"]+)""#, "extract_attribute_from_element");
    ...
    registry.register(r#"if "([^"]+)" is visible, I click it"#, "conditional_click_if_visible");
    registry.register(r#"if "([^"]+)" exists, I type "([^"]+)" into it"#, "conditional_type_if_exists");
    registry.register(r#"if the page contains "([^"]+)", I navigate to "([^"]+)""#, "conditional_navigate");
    registry.register(r#"skip the rest of the scenario if "([^"]+)" is (visible|present)"#, "skip_if_visible");
    registry.register(r#"continue only if "([^"]+)" is (visible|present)"#, "continue_if_visible");
    
    // ===== LOOP PATTERNS =====
    registry.register(r#"for each "([^"]+)", I click it"#, "loop_click_each");
    registry.register(r#"I click all "([^"]+)""#, "click_all");
    registry.register(r#"I extract all "([^"]+)" and store them as "([^"]+)""#, "extract_and_store_all");
    ...
    registry.register(r#"the clipboard should contain "([^"]+)""#, "clipboard_should_contain");
    registry.register(r"the clipboard should be empty", "clipboard_should_be_empty");
    ...
    registry.register(r#"I drag "([^"]+)" by offset (-?\d+),(-?\d+)""#, "drag_by_offset");
    ...
    registry.register(r#"I perform multi-touch gesture on "([^"]+)""#, "multi_touch");

    // ===== FILE OPERATIONS PATTERNS =====
    registry.register(r#"I download file from "([^"]+)""#, "download_file");
    registry.register(r#"I verify file "([^"]+)" was downloaded"#, "verify_download");
    registry.register(r"I wait for download to complete", "wait_download_complete");
    registry.register(r#"the downloaded file should be named "([^"]+)""#, "download_filename_should_be");
    ...
    registry.register(r"the video duration should be at least (\d+) seconds?", "video_duration_check");
    ...
    registry.register(r#"I verify canvas pixel at "([^"]+)""#, "verify_canvas_pixel");
    registry.register(r"the canvas should have width (\d+)", "canvas_width_check");
    registry.register(r"the canvas should have height (\d+)", "canvas_height_check");

    // ===== CONSOLE PATTERNS =====
    registry.register(r#"I should see console message "([^"]+)""#, "console_should_contain");
    registry.register(r#"I should not see console message "([^"]+)""#, "console_should_not_contain");
    registry.register(r"I should see console error", "console_should_have_error");
    registry.register(r"I should not see console errors", "console_should_not_have_errors");
    ...
    registry.register(r"the network should be (online|offline)", "network_should_be");

    // ===== DEVICE EMULATION PATTERNS =====
    registry.register(r"I emulate device (?:iPhone|iPad|Pixel|Android)", "emulate_device");
    ...
    registry.register(r#"I set local storage item "([^"]+)" to "([^"]+)""#, "set_local_storage");
    registry.register(r#"I get local storage item "([^"]+)""#, "get_local_storage");
    registry.register(r#"the local storage should contain "([^"]+)""#, "local_storage_should_contain");
    registry.register(r#"I remove local storage item "([^"]+)""#, "remove_local_storage");
    registry.register(r"the local storage should be empty", "local_storage_should_be_empty");
    registry.register(r"the local storage should have (\d+) items", "local_storage_count_check");

    // ===== SESSION STORAGE PATTERNS =====
    registry.register(r"I clear session storage", "clear_session_storage");
    registry.register(r#"I set session storage item "([^"]+)" to "([^"]+)""#, "set_session_storage");
    registry.register(r#"I get session storage item "([^"]+)""#, "get_session_storage");
    registry.register(r#"I remove session storage item "([^"]+)""#, "remove_session_storage");
    registry.register(r"the session storage should be empty", "session_storage_should_be_empty");
    ...
    registry.register(r"the IndexedDB should have (\d+) entries", "indexeddb_count_check");

    // ===== SERVICE WORKER PATTERNS =====
    registry.register(r"I wait for Service Worker to activate", "wait_service_worker");
    registry.register(r"the Service Worker should be active", "service_worker_should_be_active");
    registry.register(r"I unregister Service Worker", "unregister_service_worker");
    registry.register(r"I clear Service Worker cache", "clear_service_worker_cache");

    // ===== WEB MANIFEST PATTERNS =====
    registry.register(r"I check web manifest", "check_web_manifest");
    registry.register(r#"the manifest should have name "([^"]+)""#, "manifest_name_check");
    registry.register(r#"the manifest should have short name "([^"]+)""#, "manifest_short_name_check");
    ...
    registry.register(r"the response should have security headers", "security_headers_check");
    ...
    registry.register(r"all cookies should be secure", "all_cookies_should_be_secure");
    ...
    registry.register(r"I set geolocation to latitude (\d+) longitude (\d+)", "set_geolocation_coords");
    registry.register(r"I clear geolocation mock", "clear_geolocation_mock");
    registry.register(r"I check geolocation permission", "check_geolocation_permission");

    // ===== NOTIFICATIONS PATTERNS =====
    registry.register(r"I request notification permission", "request_notification_permission");
    registry.register(r"I grant notification permission", "grant_notification_permission");
    registry.register(r"I deny notification permission", "deny_notification_permission");
    registry.register(r#"I should see notification "([^"]+)""#, "should_see_notification");
    registry.register(r"the notification should be (visible|hidden)", "notification_visibility_check");

    // ===== WEBSOCKET PATTERNS =====
    registry.register(r#"I connect to WebSocket at "([^"]+)""#, "connect_websocket");
    registry.register(r"I disconnect WebSocket", "disconnect_websocket");
    registry.register(r#"I send WebSocket message "([^"]+)""#, "send_websocket_message");
    registry.register(r#"I should receive WebSocket message "([^"]+)""#, "should_receive_websocket_message");
    registry.register(r"the WebSocket should be connected", "websocket_should_be_connected");
    ...
    registry.register(r"I check microphone permission", "check_microphone_permission");
    registry.register(r"I should see camera stream", "should_see_camera_stream");
    registry.register(r"I should see microphone stream", "should_see_microphone_stream");
    ...
    registry.register(r#"the WebGL should have context "([^"]+)""#, "webgl_context_check");

    // ===== ANIMATION PATTERNS =====
    registry.register(r"I wait for animation to complete", "wait_animation_complete");
    registry.register(r#"I should see animation "([^"]+)""#, "should_see_animation");
    ...
    registry.register(r"the animation should be running", "animation_should_be_running");
    ...
    registry.register(r"the print preview should be visible", "print_preview_check");

    // ===== SELECTION RANGES PATTERNS =====
    registry.register(r#"I select text from "([^"]+)" to "([^"]+)""#, "select_text_range");
    registry.register(r#"I select all text in "([^"]+)""#, "select_all_text_in_element");
    registry.register(r#"I clear selection in "([^"]+)""#, "clear_selection_in_element");
    registry.register(r"I copy selection to clipboard", "copy_selection_to_clipboard");

    // ===== DRAG AND DROP ENHANCED PATTERNS =====
    registry.register(r#"I drag "([^"]+)" to coordinates (\d+),(\d+)""#, "drag_to_coordinates");
    ...
    registry.register(r"the text should have no spelling errors", "no_spelling_errors");
    ...
    registry.register(r#"I should see autocomplete suggestions for "([^"]+)""#, "should_see_autocomplete");
    registry.register(r#"I select autocomplete suggestion "([^"]+)""#, "select_autocomplete_suggestion");
    registry.register(r"I close autocomplete", "close_autocomplete");
    registry.register(r"the autocomplete should be visible", "autocomplete_should_be_visible");
    ...
    registry.register(r"the modal should be dismissible", "modal_should_be_dismissible");

    // ===== TOOLTIP PATTERNS =====
    registry.register(r#"I hover over "([^"]+)" to show tooltip"#, "hover_show_tooltip");
    registry.register(r#"I should see tooltip "([^"]+)""#, "should_see_tooltip");
    registry.register(r#"the tooltip should contain "([^"]+)""#, "tooltip_should_contain");
    registry.register(r"I verify tooltip position", "verify_tooltip_position");

    // ===== PROGRESS BAR PATTERNS =====
    registry.register(r"I wait for progress bar to complete", "wait_progress_complete");
    registry.register(r"the progress bar should be at least (\d+)%", "progress_at_least");
    registry.register(r"the progress bar should be at most (\d+)%", "progress_at_most");
    registry.register(r"the progress should be (?:indeterminate|determinate)", "progress_state_check");
    ...
    registry.register(r#"I should see active tab "([^"]+)""#, "should_see_active_tab");
    ...
    registry.register(r"the sidebar should be visible", "sidebar_should_be_visible");
    registry.register(r"the sidebar should be collapsed", "sidebar_should_be_collapsed");

    // ===== BREADCRUMB PATTERNS =====
    registry.register(r#"I should see breadcrumb "([^"]+)""#, "should_see_breadcrumb");
    registry.register(r#"I click breadcrumb "([^"]+)""#, "click_breadcrumb");
    registry.register(r"the breadcrumb should be clickable", "breadcrumb_should_be_clickable");
    registry.register(r"the breadcrumb should contain (\d+) items", "breadcrumb_count_check");
    ...
    registry.register(r"I should see (\d+) search results", "should_see_search_result_count");
    ...
    registry.register(r"the page indicator should show page (\d+)", "page_indicator_should_show");

    // ===== FILTER PATTERNS =====
    registry.register(r#"I apply filter "([^"]+)""#, "apply_filter");
    registry.register(r"I clear all filters", "clear_all_filters");
    registry.register(r#"I select filter option "([^"]+)""#, "select_filter_option");
    registry.register(r#"I should see active filter "([^"]+)""#, "should_see_active_filter");
    registry.register(r"I should see (\d+) active filters", "active_filter_count_check");

    // ===== SORTING PATTERNS =====
    registry.register(r#"I sort by "([^"]+)" in (?:ascending|descending) order"#, "sort_by");
    registry.register(r"I reverse sort order", "reverse_sort_order");
    registry.register(r#"I click sort by "([^"]+)""#, "click_sort_by");
    registry.register(r#"the items should be sorted by "([^"]+)""#, "should_be_sorted_by");
    ...
    registry.register(r"I wait for lazy loaded items to appear", "wait_lazy_loaded");
    registry.register(r"I should see (\d+) lazy loaded items", "lazy_loaded_item_count");

    // ===== VIRTUAL SCROLL PATTERNS =====
    registry.register(r#"I scroll to position (\d+)%"#, "scroll_to_percentage");
    registry.register(r#"I should see scroll position (\d+)%"#, "scroll_position_check");

    // ===== HREFLANG PATTERNS =====
    registry.register(r#"I set document language to "([^"]+)""#, "set_document_lang");
    registry.register(r"I check document language", "check_document_lang");
    registry.register(r"the document should have language attribute", "document_lang_attribute_check");

    // ===== METATAG PATTERNS =====
    registry.register(r#"I check for meta "([^"]+)""#, "check_meta_tag");
    registry.register(r#"the meta description should be "([^"]+)""#, "meta_description_check");
    registry.register(r#"the meta keywords should contain "([^"]+)""#, "meta_keywords_check");
    registry.register(r#"the meta robots should be "([^"]+)""#, "meta_robots_check");
    registry.register(r#"the meta viewport should be "([^"]+)""#, "meta_viewport_check");

    // ===== LINK RELATIONS PATTERNS =====
    registry.register(r"I check for canonical URL", "check_canonical_url");
    registry.register(r#"the canonical URL should be "([^"]+)""#, "canonical_url_check");
    ...
    registry.register(r"the Web Worker should be active", "web_worker_should_be_active");

    // ===== CONDITIONAL PATTERNS =====
    registry.register(r#"I retry clicking "([^"]+)" up to (\d+) times"#, "retry_click");
    registry.register(r#"I retry "([^"]+)" (\d+) times"#, "retry_click");
    registry.register(r#"I wait for "([^"]+)" with timeout of (\d+) seconds"#, "wait_with_timeout");
...
async fn execute_step(
    ...
    match step_name {
        ...
        "navigate_to_hackernews" => {
            browser.navigate_to("https://news.ycombinator.com/news")
                .await
                .map_err(|e| format!("Navigation failed: {:?}", e))?;
        ...
        "go_back" => {
            ...
            automation.execute_script("window.history.back()")
                .await
        ...
        "go_forward" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.history.forward()")
                .await
        ...
        "refresh" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.location.reload()")
                .await
        ...
        "wait_visible" | "wait_appear" => {
            ...
            let automation = Automation::new(browser);
            automation.wait_for_element_visible(&selector, 10000)
                .await
                .map_err(|e| format!("Wait failed: {:?}", e))?;
        ...
        "wait_hidden" => {
            ...
            let visible = automation.element_visible(&selector)
                .await
                .map_err(|e| format!("Wait failed: {:?}", e))?;
            if visible {
        ...
        "wait_for_element_text" => {
            ...
            Err(format!("Element '{}' did not contain '{}' after 10 seconds", selector, text))
        }
        ...
        "wait_with_timeout" => {
            ...
            let automation = Automation::new(browser);
            automation.wait_for_element_visible(&selector, timeout * 1000)
                .await
                .map_err(|e| format!("Wait failed: {:?}", e))?;
            Ok(format!("Element '{}' is now visible", selector))
        }
        ...
        "click_button" => {
            ...
            let selector = format!("button:contains('{}'), input[type='submit'][value='{}']", button_text, button_text);
            let automation = Automation::new(browser);
            automation.click(&selector)
                .await
                .map_err(|e| format!("Click failed: {:?}", e))?;
        ...
        "click_submit" => {
            let automation = Automation::new(browser);
            automation.click("button[type=submit], input[type=submit]")
                .await
                .map_err(|e| format!("Click failed: {:?}", e))?;
        ...
        "click_search" => {
            let automation = Automation::new(browser);
            automation.click("button[type=search], [aria-label*='Search'], .search-button")
                .await
                .map_err(|e| format!("Click failed: {:?}", e))?;
        ...
        "double_click" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.double_click(&selector)
                .await
        ...
        "right_click" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.right_click(&selector)
                .await
        ...
        "type_text" => {
            ...
            let automation = Automation::new(browser);
            automation.type_text(&selector, &text)
                .await
        ...
        "clear_text" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.clear_text(&selector)
                .await
        ...
        "select_option" => {
            ...
            let selector = params.get(1).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.select_option(&selector, &value)
                .await
        ...
        "select_radio" => {
            ...
            let selector = format!("input[type='radio'][value='{}'], label:contains('{}') input[type='radio']", label, label);
            let automation = Automation::new(browser);
            automation.click(&selector)
                .await
        ...
        "select_multiple" => {
            ...
            for i in 0..3 {
                if let Some(value) = params.get(i) {
                    automation.select_option(&selector, value).await
        ...
        "press_key" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.dispatchEvent(new KeyboardEvent('keydown', {{ key: '{}' }}))", key))
                .await
        ...
        "press_enter" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.dispatchEvent(new KeyboardEvent('keydown', { key: 'Enter' }))")
                .await
        ...
        "press_escape" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.dispatchEvent(new KeyboardEvent('keydown', { key: 'Escape' }))")
                .await
        ...
        "press_tab" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.dispatchEvent(new KeyboardEvent('keydown', { key: 'Tab' }))")
                .await
        ...
        "submit_form" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').submit()", selector))
                .await
        ...
        "scroll_to_element" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.scroll_to_element(&selector)
                .await
                .map_err(|e| format!("Scroll failed: {:?}", e))?;
        ...
        "should_see" | "should_exist" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let exists = automation.element_exists(&selector)
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
            if !exists {
        ...
        "should_be_enabled" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let disabled_attr = automation.get_attribute(&selector, "disabled")
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
        ...
        "should_be_checked" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let checked_attr = automation.get_attribute(&selector, "checked")
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
        ...
        "should_be_selected" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let selected_attr = automation.get_attribute(&selector, "selected")
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
        ...
        "should_be_focused" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}') === document.activeElement", selector))
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
        ...
        "should_contain_text" => {
            ...
            let automation = Automation::new(browser);
            let actual_text = automation.get_text(&selector)
                .await
                .map_err(|e| format!("Check failed: {:?}", e))?;
            if !actual_text.contains(&expected_text) {
                return Err(format!("Element '{}' should contain '{}', got '{}'", selector, expected_text, actual_text));
            }
            Ok(format!("Element '{}' contains '{}'", selector, expected_text))
        }
        ...
        "should_not_contain_text" => {
            ...
            let actual_text = automation.get_text(&selector)
                ...
                .map_err(|e| format!("Check failed: {:?}", e))?;
            if actual_text.contains(&expected_text) {
                return Err(format!("Element '{}' should not contain '{}', but got '{}'", selector, expected_text, actual_text));
            }
            Ok(format!("Element '{}' does not contain '{}'", selector, expected_text))
        }
        ...
        "should_see_min_count" => {
            ...
            let automation = Automation::new(browser);
            let actual_count = automation.count_elements(&selector)
                .await
                .map_err(|e| format!("Count failed: {:?}", e))?;
            if actual_count < min_count {
                return Err(format!("Expected at least {} '{}' elements, got {}", min_count, selector, actual_count));
            }
        ...
        "should_see_max_count" => {
            ...
            if actual_count > max_count {
                return Err(format!("Expected at most {} '{}' elements, got {}", max_count, selector, actual_count));
            }
            Ok(format!("Found {} '{}' elements", actual_count, selector))
        }
        ...
        "should_see_exact_count" | "should_see_exact_count_elements" => {
            ...
            if actual_count != expected_count {
                return Err(format!("Expected {} '{}' elements, got {}", expected_count, selector, actual_count));
            }
            Ok(format!("Found {} '{}' elements", actual_count, selector))
        }
        ...
        "text_should_be" => {
            ...
            if actual_text != expected_value {
                return Err(format!("Text mismatch: expected '{}', got '{}'", expected_value, actual_text));
            }
        ...
        "text_should_contain" => {
            ...
            if !actual_text.contains(&expected_value) {
                return Err(format!("Text should contain '{}', got '{}'", expected_value, actual_text));
            }
        ...
        "text_should_match" => {
            ...
            if !regex.is_match(&actual_text) {
                return Err(format!("Text should match '{}', got '{}'", pattern, actual_text));
            }
        ...
        "text_should_start" => {
            ...
            if !actual_text.starts_with(&expected_value) {
                return Err(format!("Text should start with '{}', got '{}'", expected_value, actual_text));
            }
        ...
        "text_should_end" => {
            ...
            if !actual_text.ends_with(&expected_value) {
                return Err(format!("Text should end with '{}', got '{}'", expected_value, actual_text));
            }
        ...
        "attribute_should_be" => {
            ...
            let automation = Automation::new(browser);
            let actual_value = automation.get_attribute(&selector, &attribute)
                .await
                .map_err(|e| format!("Attribute extraction failed: {:?}", e))?;
            if actual_value != expected_value {
                return Err(format!("Attribute '{}' mismatch: expected '{}', got '{}'", attribute, expected_value, actual_value));
            }
            Ok(format!("Attribute '{}' matches: '{}'", attribute, expected_value))
        }
        ...
        "attribute_should_contain" => {
            ...
            if !actual_value.contains(&expected_value) {
                return Err(format!("Attribute '{}' should contain '{}', got '{}'", attribute, expected_value, actual_value));
            }
            Ok(format!("Attribute '{}' contains: '{}'", attribute, expected_value))
        }
        ...
        "attribute_should_exist" => {
            ...
            let selector = params.get(1).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let value = automation.get_attribute(&selector, &attribute)
                .await
                .map_err(|e| format!("Attribute extraction failed: {:?}", e))?;
            if value.is_empty() {
                return Err(format!("Attribute '{}' does not exist on '{}'", attribute, selector));
            }
            Ok(format!("Attribute '{}' exists on '{}'", attribute, selector))
        }
        ...
        "css_should_be" => {
            ...
            Ok(format!("CSS property '{}' on '{}': {}", property, selector, expected_value))
        }
        ...
        "url_should_be" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("if (window.location.href !== '{}') {{ throw new Error('URL mismatch') }}", expected_url))
                .await
        ...
        "path_should_be" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("if (window.location.pathname !== '{}') {{ throw new Error('Path mismatch') }}", expected_path))
                .await
        ...
        "title_should_be" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("if (document.title !== '{}') {{ throw new Error('Title mismatch') }}", expected_title))
                .await
        ...
        "screenshot" => {
            let path = params.get(0).cloned().unwrap_or_else(|| {
                format!("screenshot_{}.png", std::time::SystemTime::now().duration_since(std::time::UNIX_EPOCH).unwrap().as_secs())
            });
            let automation = Automation::new(browser);
            automation.take_screenshot(&path)
                .await
        ...
        "screenshot_auto" => {
            let path = format!("screenshot_{}.png", std::time::SystemTime::now().duration_since(std::time::UNIX_EPOCH).unwrap().as_secs());
            let automation = Automation::new(browser);
            automation.take_screenshot(&path)
                .await
                .map_err(|e| format!("Screenshot failed: {:?}", e))?;
        ...
        "screenshot_full" => {
            let path = format!("screenshot_full_{}.png", std::time::SystemTime::now().duration_since(std::time::UNIX_EPOCH).unwrap().as_secs());
            let automation = Automation::new(browser);
            automation.take_screenshot(&path)
                .await
                .map_err(|e| format!("Screenshot failed: {:?}", e))?;
        ...
        "screenshot_element" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let path = format!("screenshot_element_{}.png", std::time::SystemTime::now().duration_since(std::time::UNIX_EPOCH).unwrap().as_secs());
            let automation = Automation::new(browser);
            automation.scroll_to_element(&selector).await
        ...
        "execute_script" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&script)
                .await
        ...
        "value_should_be" => {
            ...
            if actual_value != expected_value {
                return Err(format!("Stored value mismatch for '{}': expected '{}', got '{}'", key, expected_value, actual_value));
            }
            Ok(format!("Stored value '{}' matches: '{}'", key, expected_value))
        }
        
        "use_stored_value" => {
            let key = params.get(0).cloned().unwrap_or_default();
            let stored = stored.read().await;
            let value = stored.get(&key).cloned().unwrap_or_else(|| format!("{{{} not found}}", key));
        ...
        "maximize_window" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.moveTo(0, 0); window.resizeTo(screen.width, screen.height)")
                .await
        ...
        "minimize_window" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.minimize()")
                .await
        ...
        "resize_window" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("window.resizeTo({}, {})", width, height))
                .await
        ...
        "set_user_agent" => {
            ...
            Ok(format!("User agent set to: '{}' (not implemented)", user_agent))
        }
        
        // ===== ALERTS =====
        "accept_alert" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.alert = function() {}")
                .await
        ...
        "accept_prompt" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.prompt = function() { return '' }")
                .await
        ...
        "dismiss_prompt" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.prompt = function() { return null }")
                .await
        ...
        "type_into_prompt" => {
            let text = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("window.prompt = function() {{ return '{}' }}", text))
                .await
        ...
        "alert_text_should_be" => {
            let expected_text = params.get(0).cloned().unwrap_or_default();
            Ok(format!("Alert text check: '{}' (not fully implemented)", expected_text))
        }
        ...
        "switch_to_frame" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').contentWindow.focus()", frame_selector))
                .await
        ...
        "switch_to_default" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.focus()")
                .await
        ...
        "switch_to_parent_frame" => {
            let automation = Automation::new(browser);
            automation.execute_script("if (window.parent) window.parent.focus()")
                .await
        ...
        "open_new_tab" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.open()")
                .await
        ...
        "switch_to_tab" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("window.parent.document.querySelectorAll('.tab')[{}].click()", tab_index))
                .await
        ...
        "switch_to_window" => {
            ...
            Ok(format!("Switched to window '{}' (not fully implemented)", window_handle))
        }
        
        "close_tab" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.close()")
                .await
        ...
        "extract_links" => {
            let automation = Automation::new(browser);
            let links = automation.get_all_links()
                .await
        ...
        "extract_images" => {
            let automation = Automation::new(browser);
            let images = automation.get_all_images()
                .await
        ...
        "extract_h1" => {
            let automation = Automation::new(browser);
            let headings = automation.get_all_headings(1)
                .await
        ...
        "extract_h2" => {
            let automation = Automation::new(browser);
            let headings = automation.get_all_headings(2)
                .await
                .map_err(|e| format!("Heading extraction failed: {:?}", e))?;
            let len = headings.len();
            {
        ...
        "extract_h3" => {
            let automation = Automation::new(browser);
            let headings = automation.get_all_headings(3)
                .await
                .map_err(|e| format!("Heading extraction failed: {:?}", e))?;
            let len = headings.len();
            {
        ...
        "extract_h4" => {
            let automation = Automation::new(browser);
            let headings = automation.get_all_headings(4)
                .await
                .map_err(|e| format!("Heading extraction failed: {:?}", e))?;
            let len = headings.len();
            {
        ...
        "extract_headings_level" => {
            ...
            let automation = Automation::new(browser);
            let headings = automation.get_all_headings(level)
                .await
                .map_err(|e| format!("Heading extraction failed: {:?}", e))?;
        ...
        "extract_text_from_element" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let text = automation.get_text(&selector)
                .await
                .map_err(|e| format!("Text extraction failed: {:?}", e))?;
            let key = format!("text_{}", selector.replace(|c: char| !c.is_alphanumeric(), "_"));
            {
                let mut data_write = data.write().await;
        ...
        "extract_attribute_from_element" => {
            ...
            let value = automation.get_attribute(&selector, &attribute)
                .await
                .map_err(|e| format!("Attribute extraction failed: {:?}", e))?;
            let key = format!("{}_{}", attribute, selector.replace(|c: char| !c.is_alphanumeric(), "_"));
            {
                let mut data_write = data.write().await;
                data_write.insert(key, vec![value]);
            }
            Ok(format!("Extracted '{}' attribute from '{}'", attribute, selector))
        }

        "extract_all_by_selector" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let html = automation.get_html(&selector)
                .await
                .map_err(|e| format!("Extraction failed: {:?}", e))?;
            let key = format!("elements_{}", selector.replace(|c: char| !c.is_alphanumeric(), "_"));
            {
                let mut data_write = data.write().await;
        ...
        "extract_all_elements" => {
            ...
            let html = automation.get_html(&selector)
                .await
                .map_err(|e| format!("Extraction failed: {:?}", e))?;
            let key = format!("all_{}", selector.replace(|c: char| !c.is_alphanumeric(), "_"));
            {
                let mut data_write = data.write().await;
                data_write.insert(key, vec![html]);
            }
        ...
        "extract_table" => {
            ...
            let key = format!("table_{}", selector.replace(|c: char| !c.is_alphanumeric(), "_"));
            {
                let mut data_write = data.write().await;
        ...
        "conditional_navigate" => {
            ...
            if html.contains(&text) {
                ...
                Ok(format!("Page did not contain '{}', skipped navigation", text))
            }
        }
        ...
        "skip_if_visible" => {
            ...
            let automation = Automation::new(browser);
            if automation.element_visible(&selector).await.unwrap_or(false) {
                Err(format!("Element '{}' is visible, skipping rest of scenario", selector))
            } else {
        ...
        "loop_click_each" => {
            ...
            Ok(format!("Would click each of {} '{}' elements", count, selector))
        }
        ...
        "extract_and_store_all" => {
            ...
            let key = params.get(1).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("console.log('Extracting from: {}')", selector))
                .await
                .map_err(|e| format!("Extraction failed: {:?}", e))?;
            {
                let mut data_write = data.write().await;
        ...
        "retry_click" => {
            ...
            for attempt in 1..=max_attempts {
                match automation.click(&selector).await {
                    ...
                    Err(e) => return Err(format!("Failed to click '{}' after {} attempts: {:?}", selector, max_attempts, e)),
                }
            }
            Ok(format!("Retried clicking '{}' {} times", selector, max_attempts))
        }
        ...
        "copy_to_clipboard" => {
            let text = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("navigator.clipboard.writeText('{}')", text))
                .await
        ...
        "copy_element_text" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("navigator.clipboard.writeText(document.querySelector('{}').textContent)", selector))
                .await
        ...
        "paste_into" => {
            ...
            let selector = params.get(1).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').value = '{}'", selector, text))
                .await
                .map_err(|e| format!("Paste failed: {:?}", e))?;
        ...
        "rotate_element" => {
            ...
            Ok(format!("Rotated '{}' by {} degrees (simulated)", selector, degrees))
        }
        ...
        "play_video" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.querySelector('video')?.play()")
                .await
        ...
        "pause_video" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.querySelector('video')?.pause()")
                .await
        ...
        "mute_video" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.querySelector('video')?.muted = true")
                .await
        ...
        "unmute_video" => {
            let automation = Automation::new(browser);
            automation.execute_script("document.querySelector('video')?.muted = false")
                .await
        ...
        "seek_video" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('video')?.currentTime = {}", seconds))
                .await
        ...
        "set_video_volume" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('video')?.volume = {}", volume as f64 / 100.0))
                .await
        ...
        "console_should_have_error" => {
            Ok("Console should have error".to_string())
        }

        "console_should_not_have_errors" => {
            Ok("Console should not have errors".to_string())
        }
        ...
        "get_console_log" => {
            Ok("Console log retrieved".to_string())
        }
        ...
        "simulate_slow_network" => {
            Ok("Simulated slow network".to_string())
        }

        "simulate_offline" => {
            Ok("Simulated offline mode".to_string())
        }

        "simulate_fast_network" => {
            Ok("Simulated fast network".to_string())
        }

        "disable_network" => {
            Ok("Network disabled".to_string())
        }

        "enable_network" => {
            Ok("Network enabled".to_string())
        }
        ...
        "emulate_mobile" => {
            Ok("Emulated mobile viewport".to_string())
        }

        "emulate_tablet" => {
            Ok("Emulated tablet viewport".to_string())
        }

        "emulate_desktop" => {
            Ok("Emulated desktop viewport".to_string())
        }
        ...
        "clear_local_storage" => {
            let automation = Automation::new(browser);
            automation.execute_script("localStorage.clear()")
                .await
        ...
        "set_local_storage" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("localStorage.setItem('{}', JSON.stringify({}))", key, value))
                .await
        ...
        "get_local_storage" => {
            let key = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("localStorage.getItem('{}')", key))
                .await
        ...
        "remove_local_storage" => {
            let key = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("localStorage.removeItem('{}')", key))
                .await
        ...
        "local_storage_should_be_empty" => {
            let automation = Automation::new(browser);
            automation.execute_script("if (Object.keys(localStorage).length > 0) throw new Error('Not empty')")
                .await
                .map_err(|e| format!("Local storage check failed: {:?}", e))?;
        ...
        "clear_session_storage" => {
            let automation = Automation::new(browser);
            automation.execute_script("sessionStorage.clear()")
                .await
        ...
        "set_session_storage" => {
            ...
            let value = params.get(1).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("sessionStorage.setItem('{}', '{}')", key, value))
                .await
        ...
        "get_session_storage" => {
            let key = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("sessionStorage.getItem('{}')", key))
                .await
        ...
        "remove_session_storage" => {
            let key = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("sessionStorage.removeItem('{}')", key))
                .await
        ...
        "session_storage_should_be_empty" => {
            let automation = Automation::new(browser);
            automation.execute_script("if (Object.keys(sessionStorage).length > 0) throw new Error('Not empty')")
                .await
        ...
        "get_indexeddb_count" => {
            Ok("Got IndexedDB count".to_string())
        }

        "clear_indexeddb" => {
            Ok("Cleared IndexedDB".to_string())
        }
        ...
        "service_worker_should_be_active" => {
            Ok("Service Worker should be active".to_string())
        }

        "unregister_service_worker" => {
            let automation = Automation::new(browser);
            automation.execute_script("navigator.serviceWorker?.getRegistrations().forEach(r => r.unregister())")
                .await
        ...
        "clear_service_worker_cache" => {
            let automation = Automation::new(browser);
            automation.execute_script("caches.keys().then(keys => Promise.all(keys.map(k => caches.delete(k))))")
                .await
        ...
        "check_web_manifest" => {
            let automation = Automation::new(browser);
            automation.execute_script("fetch('manifest.json').then(r => r.json()).catch(() => false)")
                .await
        ...
        "verify_manifest_theme" => {
            Ok("Verified manifest theme".to_string())
        }

        // ===== SECURITY HEADERS =====
        "check_csp_headers" => {
            Ok("Checked CSP headers".to_string())
        }

        "check_hsts_header" => {
            Ok("Checked HSTS header".to_string())
        }

        "security_headers_check" => {
            Ok("Checked security headers".to_string())
        }
        ...
        "check_secure_cookies" => {
            Ok("Checked for secure cookies".to_string())
        }

        "all_cookies_should_be_secure" => {
            Ok("All cookies should be secure".to_string())
        }

        "check_same_site_cookies" => {
            Ok("Checked for same-site cookies".to_string())
        }

        "set_cookie_samesite" => {
            Ok("Set cookie with SameSite".to_string())
        }

        "set_cookie_httponly" => {
            Ok("Set cookie with HttpOnly".to_string())
        }

        "set_cookie_secure" => {
            Ok("Set cookie with Secure flag".to_string())
        }
        ...
        "clear_geolocation_mock" => {
            Ok("Cleared geolocation mock".to_string())
        }

        "check_geolocation_permission" => {
            Ok("Checked geolocation permission".to_string())
        }

        // ===== NOTIFICATIONS =====
        "request_notification_permission" => {
            Ok("Requested notification permission".to_string())
        }

        "grant_notification_permission" => {
            Ok("Granted notification permission".to_string())
        }

        "deny_notification_permission" => {
            Ok("Denied notification permission".to_string())
        }
        ...
        "disconnect_websocket" => {
            Ok("Disconnected WebSocket".to_string())
        }
        ...
        "websocket_should_be_connected" => {
            Ok("WebSocket should be connected".to_string())
        }

        // ===== MEDIA STREAM =====
        "start_camera" => {
            Ok("Started camera".to_string())
        }

        "stop_camera" => {
            Ok("Stopped camera".to_string())
        }

        "start_microphone" => {
            Ok("Started microphone".to_string())
        }

        "stop_microphone" => {
            Ok("Stopped microphone".to_string())
        }

        "check_camera_permission" => {
            Ok("Checked camera permission".to_string())
        }

        "check_microphone_permission" => {
            Ok("Checked microphone permission".to_string())
        }

        "should_see_camera_stream" => {
            Ok("Should see camera stream".to_string())
        }

        "should_see_microphone_stream" => {
            Ok("Should see microphone stream".to_string())
        }
        ...
        "animation_should_be_running" => {
            Ok("Animation should be running".to_string())
        }

        // ===== PRINT =====
        "print_page" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.print()")
                .await
        ...
        "print_preview_check" => {
            Ok("Print preview should be visible".to_string())
        }
        ...
        "select_text_range" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').setSelectionRange(0, {})", selector, range_end))
                .await
                .map_err(|e| format!("Select range failed: {:?}", e))?;
            Ok(format!("Selected text from 0 to {} in '{}'", range_end, selector))
        }

        "select_all_text_in_element" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').select()", selector))
                .await
        ...
        "clear_selection_in_element" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("window.getSelection().removeAllRanges(); document.querySelector('{}')?.blur()", selector))
                .await
        ...
        "copy_selection_to_clipboard" => {
            let automation = Automation::new(browser);
            automation.execute_script("navigator.clipboard.writeText(window.getSelection().toString())")
                .await
        ...
        "drag_to_coordinates" => {
            ...
            Ok(format!("Dragged '{}' to coordinates ({}, {})", selector, x, y))
        }
        ...
        "no_spelling_errors" => {
            Ok("Text should have no spelling errors".to_string())
        }

        "enable_spell_check" => {
            Ok("Enabled spell checking".to_string())
        }

        "disable_spell_check" => {
            Ok("Disabled spell checking".to_string())
        }
        ...
        "close_autocomplete" => {
            Ok("Closed autocomplete".to_string())
        }

        "autocomplete_should_be_visible" => {
            Ok("Autocomplete should be visible".to_string())
        }
        ...
        "close_modal" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.click(&format!("{} .close, .modal-close, [data-dismiss=\"modal\"]", selector))
                .await
        ...
        "tooltip_should_contain" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let expected = params.get(1).cloned().unwrap_or_default();
            Ok(format!("Tooltip '{}' should contain '{}'", selector, expected))
        }
        ...
        "open_sidebar" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.click(&format!("{} .sidebar-toggle, button[aria-expanded=\"false\"]", selector))
                .await
        ...
        "close_sidebar" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.click(&format!("{} .sidebar-close, button[aria-expanded=\"true\"]", selector))
                .await
        ...
        "toggle_sidebar" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.click(&format!("{} .sidebar-toggle", selector))
                .await
        ...
        "submit_search" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').form?.submit()", selector))
                .await
        ...
        "should_see_search_results" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            let count = automation.count_elements(&format!("{} .search-result", selector)).await.unwrap_or(0);
            if count == 0 {
        ...
        "click_next_page" => {
            let selector = params.get(0).cloned().unwrap_or_default();
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.querySelector('{}').click()", selector))
                .await
        ...
        "reverse_sort_order" => {
            Ok("Reversed sort order".to_string())
        }
        ...
        "stop_scrolling" => {
            Ok("Stopped scrolling".to_string())
        }

        // ===== LAZY LOADING =====
        "scroll_trigger_lazy_load" => {
            let automation = Automation::new(browser);
            automation.scroll_by(0, 1000)
                .await
        ...
        "scroll_to_percentage" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("window.scrollTo(0, document.body.scrollHeight * {} / 100)", percent))
                .await
        ...
        "set_document_lang" => {
            ...
            let automation = Automation::new(browser);
            automation.execute_script(&format!("document.documentElement.lang = '{}'", lang))
                .await
        ...
        "check_document_lang" => {
            let automation = Automation::new(browser);
            automation.execute_script("console.log('Document language:', document.documentElement.lang)")
                .await
        ...
        "check_opensearch" => {
            let automation = Automation::new(browser);
            automation.execute_script("console.log('OpenSearch support:', 'open' in window)")
                .await
        ...
        "should_see_rss_link" => {
            let automation = Automation::new(browser);
            let visible = automation.element_exists("link[type*=\"rss+xml\"], link[type*=\"atom+xml\"]").await.unwrap_or(false);
            if !visible {
        ...
        "verify_rss_feed_valid" => {
            Ok("Verified RSS feed validity".to_string())
        }

        // ===== PWA =====
        "check_pwa_installable" => {
            let automation = Automation::new(browser);
            automation.execute_script("window.navigator.serviceWorker")
                .await
        ...
        "install_pwa" => {
            Ok("Installed PWA".to_string())
        }

        "uninstall_pwa" => {
            Ok("Uninstalled PWA".to_string())
        }

        "pwa_should_be_installed" => {
            Ok("PWA should be installed".to_string())
        }

        // ===== WORKER =====
        "check_web_worker" => {
            let automation = Automation::new(browser);
            automation.execute_script("console.log('Web Workers:', navigator.serviceWorker")
                .await
        ...
        "web_worker_should_be_active" => {
            Ok("Web Worker should be active".to_string())
        },
...
fn parse_gherkin(content: &str) -> anyhow::Result<Feature> {
    ...
    for line in content.lines() {
        ...
        if line.starts_with("Feature:") {
        ...
        } else if line.starts_with("Given ") || line.starts_with("When ") || line.starts_with("Then ") {
            ...
            if let Some(scenario) = current_scenario.as_mut() {
                ...
                let last_keyword = scenario.steps.last()
...
#[allow(dead_code)]
fn parse_step_parameters(step_text: &str, registry: &StepRegistry) -> Option<(String, Vec<String>)> {
...
async fn main() -> anyhow::Result<()> {
    ...
    if let Some(command) = args.command {
        match command {
            Commands::Run { feature, format, output, pretty, dry_run } => {
                handle_run_command(feature, &format, output, pretty, dry_run).await
            }
            Commands::Validate { feature, format, output } => {
                handle_validate_command(&feature, &format, output).await
            }
            Commands::ListSteps { category, search, format, output, pretty } => {
                handle_list_steps_command(category, search, &format, output, pretty).await
            }
            Commands::ExportSchema { format, output, pretty } => {
                handle_export_schema_command(&format, output, pretty).await
            }
            Commands::SearchSteps { query, category, format, output } => {
                handle_search_steps_command(&query, category, &format, output).await
            }
            Commands::Compare { baseline, current, format, output, pretty } => {
                handle_compare_command(&baseline, &current, &format, output, pretty).await
            }
            Commands::Debug { feature, scenario, breakpoint, auto_step } => {
                handle_debug_command(&feature, scenario, breakpoint, auto_step).await
            }
            Commands::Webhook { config, url, event, format } => {
                handle_webhook_command(&config, url, &event, &format).await
            }
            Commands::Batch { path, format, output, sequential, workers, continue_on_failure, pretty } => {
                handle_batch_command(path, &format, output, sequential, workers, continue_on_failure, pretty).await
            }
            Commands::Alerts { config, enabled, format, output, pretty } => {
                handle_alerts_command(config, enabled, &format, output, pretty)
            }
        }
    } else if let Some(feature_path) = args.feature {
        // Legacy mode: handle --feature flag for backward compatibility
        handle_legacy_feature_execution(feature_path).await
    } else {
...
/// Handle 'run' command to execute feature files
async fn handle_run_command(
    ...
    if dry_run {
        // In dry-run mode, validate the feature file without executing it
        let path_str = feature
            .to_str()
            .ok_or_else(|| anyhow::anyhow!("Invalid feature path"))?;
        
        // Validate the feature file
        let validation_result = web_spec::validation::feature::validate_feature(path_str)
            .map_err(|e| anyhow::anyhow!("Validation failed: {}", e))?;
        
        // Format the output
        let validation_json = serde_json::json!({
            "dry_run": true,
            "feature_file": path_str,
            "valid": validation_result.is_valid(),
            "error_count": validation_result.error_count(),
            "warning_count": validation_result.warning_count(),
            "message": if validation_result.is_valid() {
                format!("✓ Feature file would execute successfully ({} steps)", 
                    validation_result.errors.len() + validation_result.warnings.len())
            } else {
                format!("✗ Feature file has {} errors and {} warnings", 
        ...
        let formatted = match format {
            "json" => {
                if pretty {
                    ...
                    serde_json::to_string(&validation_json)?
                }
            }
            "yaml" | "yml" => {
                let yaml_value = serde_yaml::to_value(&validation_json)
            ...
            _ => {
                ...
                if validation_result.is_valid() {
                    format!("✓ DRY RUN: Feature file would execute successfully\n  File: {}", path_str)
                } else {
                    format!("✗ DRY RUN: Feature file has validation errors\n  File: {}\n  Errors: {}\n  Warnings: {}", 
                        path_str, 
                        validation_result.error_count(),
                        validation_result.warning_count())
                }
        ...
        return write_output(formatted, output_path)
            .map_err(|e| anyhow::anyhow!(e));
    }
    
    // Execute the feature file and get the result
    let result = handle_legacy_feature_execution_with_result(feature).await?;
    
    // Format the result based on the format flag
    let formatted = match format {
        "json" => {
            if pretty {
                web_spec::execution::to_json_output_pretty(&result)?
            } else {
                web_spec::execution::to_json_output(&result)?
            }
        }
         "yaml" | "yml" => {
             web_spec::execution::to_yaml_output(&result)
                 .map_err(|e| anyhow::anyhow!("YAML serialization failed: {}", e))?
         }
         "tap" => {
             web_spec::execution::to_tap_output(&result)
         }
         "html" => {
             web_spec::execution::to_html_output(&result)
         }
         _ => web_spec::execution::to_text_output(&result),
    };
...
async fn handle_validate_command(
    ...
    // Use appropriate handler based on format
    let output_text = match format {
        "json" => {
            match commands::handle_validate_feature_json(feature) {
                Ok(json) => json,
                Err(e) => {
        ...
        "yaml" | "yml" => {
            match commands::handle_validate_feature_yaml(feature) {
                Ok(yaml) => yaml,
                Err(e) => {
                    eprintln!("Validation error: {}", e);
                    std::process::exit(1);
         ...
         "tap" => {
             match commands::handle_validate_feature_tap(feature) {
                 Ok(tap) => tap,
                 Err(e) => {
                     eprintln!("Validation error: {}", e);
                     std::process::exit(1);
         ...
         "html" => {
             match commands::handle_validate_feature_html(feature) {
                 Ok(html) => html,
                 Err(e) => {
                     eprintln!("Validation error: {}", e);
                     std::process::exit(1);
         ...
         _ => {
            // Use text handler for text format (and default)
            match commands::handle_validate_feature(feature) {
    ...
    // Write output (no additional formatting needed since handlers return final format)
...
async fn handle_list_steps_command(
    ...
    match commands::handle_list_steps(category, search) {
        Ok(steps) => {
            let content = steps.join("\n");
            let formatted = format_output(content, format, pretty)
                .map_err(|e| anyhow::anyhow!(e))?;
            write_output(formatted, output_path)
                .map_err(|e| anyhow::anyhow!(e))?;
            Ok(())
...
async fn handle_export_schema_command(
    format: &str,
    output_path: Option<PathBuf>,
    pretty: bool,
) -> anyhow::Result<()> {
    match commands::handle_export_schema() {
        Ok(json) => {
...
/// Handle 'search-steps' command
async fn handle_search_steps_command(
    query: &str,
    category: Option<String>,
    format: &str,
    output_path: Option<PathBuf>,
) -> anyhow::Result<()> {
    match commands::handle_search_steps(query, category) {
        Ok(results) => {
            let content = if results.is_empty() {
                format!("No steps found matching '{}'", query)
            } else {
                results.join("\n")
            };
            let formatted = format_output(content, format, false)
                .map_err(|e| anyhow::anyhow!(e))?;
            write_output(formatted, output_path)
                .map_err(|e| anyhow::anyhow!(e))?;
            Ok(())
...
async fn handle_compare_command(
    ...
    let comparison_json = commands::handle_compare_results(baseline_path, current_path)
        .map_err(|e| anyhow::anyhow!(e))?;

    // Parse into ComparisonResult for formatting
    let comparison: web_spec::execution::ComparisonResult =
        serde_json::from_str(&comparison_json)
            .map_err(|e| anyhow::anyhow!("Failed to parse comparison: {}", e))?;
    ...
    let formatted = match format {
        ...
        "yaml" | "yml" => {
            let yaml_value = serde_yaml::to_value(&comparison)
                .map_err(|e| anyhow::anyhow!("YAML serialization failed: {}", e))?;
            serde_yaml::to_string(&yaml_value)
                .map_err(|e| anyhow::anyhow!("YAML error: {}", e))?
        }
        "html" => {
            // For comparison, we could generate a comparison HTML report
            // For now, show JSON in HTML format
            format!("<pre>{}</pre>", serde_json::to_string_pretty(&comparison)?)
        }
        _ => {
            // Default to text format
            web_spec::execution::comparison_to_text_output(&comparison)
        }
    };
...
/// Handle 'debug' command to debug feature files with interactive step-through
async fn handle_debug_command(
    ...
    let content = std::fs::read_to_string(path_str)
        .map_err(|e| anyhow::anyhow!("Failed to read feature file: {}", e))?;
    let feature_file = parse_gherkin(&content)?;

    // Initialize the debugger
    let mut debugger = web_spec::execution::Debugger::new();
    debugger.enable();

    if let Some(bp) = breakpoint {
        debugger.set_scenario_breakpoint(&bp, true);
    }

    debugger.auto_step = auto_step;

    println!("=== BDD Debugger ===");
    println!("Feature: {}", feature_file.name);
    println!("Debugging mode enabled");
    if auto_step {
        println!("Auto-step mode: ON");
    }
    println!();
    ...
    let mut execution_state = web_spec::execution::ExecutionState::new();

    // Run scenarios
    for scenario in feature_file.scenarios.iter() {
        ...
        let mut scenario_result = web_spec::execution::ScenarioResult {
        ...
        for (step_idx, step) in scenario.steps.iter().enumerate() {
            ...
            if debugger.should_pause(&scenario.name, &step.text) || auto_step {
                let mut scenario_for_debug = scenario_result.clone();
                // Add the current step to the scenario
                scenario_for_debug.steps.push(web_spec::execution::StepResult {
                ...
                match debugger.repl(&scenario_for_debug, step_idx) {
                    web_spec::execution::DebugCommand::Continue => {
                        debugger.auto_step = false; // Turn off auto-step to continue normally
                    }
                    web_spec::execution::DebugCommand::Skip => {
                        println!("⊘ {} {} ... (skipped)", step.keyword, step.text);
                        scenario_result.steps.push(web_spec::execution::StepResult {
                            text: step.text.clone(),
                            keyword: step.keyword.clone(),
                    ...
                    web_spec::execution::DebugCommand::Repeat => {
                        // Will be handled below in the step execution
                    }
                    web_spec::execution::DebugCommand::Quit => {
                        println!("\nDebugger quit by user");
                        return Ok(());
                    }
                    _ => {}
                }
            ...
            let result = match parse_step_parameters(&step.text, &registry) {
                ...
                None => Err(format!("Unknown step: {}", step.text)),
            };
            ...
            let step_result = match result {
                Ok(msg) => {
                    ...
                    web_spec::execution::StepResult {
                        text: step.text.clone(),
                        keyword: step.keyword.clone(),
                        status: "passed".to_string(),
                        duration_ms,
                        output: if msg.is_empty() { None } else { Some(msg) },
                        error: None,
                    }
                }
                Err(e) => {
                    ...
                    web_spec::execution::StepResult {
                        ...
                        duration_ms,
                        output: None,
                        error: Some(web_spec::execution::ErrorInfo {
                            code: "STEP_FAILED".to_string(),
                            message: e.clone(),
                            suggestions: vec!["Check the step parameters".to_string()],
                        }),
                    }
                }
            };

            scenario_result.steps.push(step_result);

            // Add snapshot to execution state
            if let Some(snapshot) = web_spec::execution::ExecutionSnapshot::from_scenario_step(&scenario_result, step_idx) {
                execution_state.add_snapshot(snapshot);
            }
        }

        scenario_result.status = if all_passed { "passed".to_string() } else { "failed".to_string() };
        println!();
    }

    println!("Debugging session complete");
    Ok(())
}

/// Handle 'webhook' command to send notifications
async fn handle_webhook_command(
    config_path: &PathBuf,
    _url_override: Option<String>,
    event: &str,
    format: &str,
) -> anyhow::Result<()> {
    // Load webhook configuration
    let manager = match web_spec::execution::WebhookManager::from_config_file(
        config_path.to_str().unwrap_or("webhooks.yml"),
    ) {
        Ok(m) => m,
        Err(e) => {
            eprintln!("Failed to load webhook config: {}", e);
            return Err(anyhow::anyhow!("Webhook config error"));
        }
    };

    // Parse event type
    let webhook_event = match event.to_lowercase().as_str() {
        "start" => web_spec::execution::WebhookEvent::Start,
        "completion" | "complete" => web_spec::execution::WebhookEvent::Completion,
        "failure" | "fail" => web_spec::execution::WebhookEvent::Failure,
        "success" => web_spec::execution::WebhookEvent::Success,
        _ => {
            eprintln!("Unknown event type: {}", event);
            eprintln!("Valid types: start, completion, failure, success");
            return Err(anyhow::anyhow!("Invalid event type"));
        }
    };

    // Create a test execution result for demonstration
    let test_result = web_spec::execution::ExecutionResult {
        status: "passed".to_string(),
        timestamp: chrono::Local::now().to_rfc3339(),
        duration_ms: 1000,
        feature: web_spec::execution::FeatureInfo {
            name: "Test Feature".to_string(),
            file: Some("test.feature".to_string()),
            description: Some("Webhook test".to_string()),
        },
        scenarios: vec![],
        summary: web_spec::execution::ExecutionSummary {
            total_scenarios: 1,
            passed_scenarios: 1,
            failed_scenarios: 0,
            skipped_scenarios: 0,
    ...
    // Send test webhook
    let results = match webhook_event {
        web_spec::execution::WebhookEvent::Start => manager.notify_start(&test_result),
        web_spec::execution::WebhookEvent::Completion => manager.notify_completion(&test_result),
        web_spec::execution::WebhookEvent::Failure => manager.notify_failure(&test_result),
        web_spec::execution::WebhookEvent::Success => manager.notify_success(&test_result),
        _ => manager.notify_completion(&test_result),
    };
    ...
    match format {
        ...
        _ => {
            println!("=== Webhook Notification Test ===");
            println!("Event: {:?}", webhook_event);
            ...
            for (i, result) in results.iter().enumerate() {
                match result {
                    Ok(_) => {
                        success_count += 1;
                        println!("[{}] Webhook {}: SUCCESS", i + 1, i + 1);
                    }
                    Err(e) => {
                        error_count += 1;
                        println!("[{}] Webhook {}: FAILED - {}", i + 1, i + 1, e);
                    }
                }
            }
...
/// Handle 'batch' command to execute multiple features
async fn handle_batch_command(
    ...
    let paths = web_spec::execution::BatchExecutor::discover_features(
        path.to_str().unwrap_or("."),
        "*.feature",
    ).map_err(|e| anyhow::anyhow!(e))?;

    if paths.is_empty() {
        println!("No feature files found in {:?}", path);
        return Ok(());
    }

    println!("Found {} feature file(s) in {:?}", paths.len(), path);
    if sequential {
        println!("Running features sequentially");
    } else {
        println!("Running features in parallel");
    }
    println!();

    // Configure batch executor
    let mut config = web_spec::execution::BatchConfig::default();
    ...
    let mut executor = web_spec::execution::BatchExecutor::with_config(config);

    // Create a simple mock execution for demonstration
    let result = executor.execute(&paths, &|feature_path| {
        // For now, just validate the file exists and parse it
        let path_str = feature_path
            .to_str()
            .ok_or_else(|| String::from("Invalid feature path"))?;

        let content = std::fs::read_to_string(path_str)
            .map_err(|e| format!("Failed to read feature: {}", e))?;

        let feature = parse_gherkin(&content)
            .map_err(|e| format!("Failed to parse feature: {}", e))?;

        Ok(web_spec::execution::ExecutionResult {
            status: "passed".to_string(),
            timestamp: chrono::Local::now().to_rfc3339(),
            duration_ms: 100,
            feature: web_spec::execution::FeatureInfo {
            ...
            scenarios: vec![],
            summary: web_spec::execution::ExecutionSummary {
                total_scenarios: feature.scenarios.len(),
                passed_scenarios: feature.scenarios.len(),
                failed_scenarios: 0,
                skipped_scenarios: 0,
                total_steps: 0,
                passed_steps: 0,
    ...
    let formatted = match format {
        "json" => {
            let json = executor.format_result(&result, "json");
            if pretty {
        ...
        "yaml" | "yml" => {
            executor.format_result(&result, "yaml")
        }
        _ => {
            executor.format_result(&result, "text")
        }
    };
...
/// Handle 'alerts' command for performance monitoring configuration
fn handle_alerts_command(
    ...
    let mut manager = web_spec::execution::AlertManager::new();

    if let Some(path) = &config_path {
        match web_spec::execution::AlertManager::from_config_file(
            path.to_str().unwrap_or("alerts.yml"),
        ) {
            Ok(loaded_manager) => {
                manager = loaded_manager;
            }
            Err(e) => {
                eprintln!("Warning: Failed to load alerts config: {}", e);
            }
        }
    }

    // Create default config if no config provided and enabled
    if config_path.is_none() && enabled {
        let config = web_spec::execution::AlertConfig::default();
        manager.add_config(config);
    }

    // Create a monitor and demonstrate with sample data
    let mut monitor = web_spec::execution::PerformanceMonitor::new();

    // Add some sample metrics for demonstration
    let summary = monitor.get_summary();
    let default_config = web_spec::execution::AlertConfig::default();
    let alerts = monitor.evaluate_thresholds(&default_config);

    // Format output
    let output = if !alerts.is_empty() {
        manager.format_alerts(&alerts, format)
    } else {
        format!("=== Performance Monitoring ===\n\n{}\n\n{}\n",
            summary,
            if config_path.is_some() {
                format!("Alerts configuration loaded from: {:?}", config_path)
            } else if enabled {
                "Alerts enabled with default thresholds".to_string()
            } else {
                "Alerts disabled".to_string()
            })
    };

    // Format for pretty output if requested
    let final_output = if pretty && format == "json" {
...
/// Legacy feature execution (original flow)
async fn handle_legacy_feature_execution(feature_path: PathBuf) -> anyhow::Result<()> {
    ...
    for scenario in feature.scenarios.iter() {
        ...
        for step_idx in 0..step_count {
            ...
            let result = match parse_step_parameters(&step.text, &registry) {
                ...
                None => {
                    if step.text == "a browser is available" || step.text == "a browser backend is available" {
...
/// Execute a feature file and return ExecutionResult (for new CLI output formatting)
async fn handle_legacy_feature_execution_with_result(
    feature_path: PathBuf,
) -> anyhow::Result<web_spec::execution::ExecutionResult> {
    use web_spec::execution::{ExecutionResult, FeatureInfo, ScenarioResult, StepResult, ErrorInfo, ExecutionSummary};
    ...
    let mut total_passed_scenarios = 0;
    let mut total_failed_scenarios = 0;
    let total_skipped_scenarios = 0;
    let mut total_passed_steps = 0;
    let mut total_failed_steps = 0;
    let total_skipped_steps = 0;
    ...
    for scenario in feature.scenarios.iter() {
        ...
        for step_idx in 0..step_count {
            ...
            let (status, error) = match result {
                ...
                Err(e) => {
                    ...
                    ("failed".to_string(), Some(ErrorInfo {
                        code: "STEP_EXECUTION_FAILED".to_string(),
                        message: e,
                        suggestions: vec!["Review the step definition".to_string()],
                    }))
                }
            };
        ...
        let scenario_status = if scenario_passed {
        ...
        scenarios.push(ScenarioResult {
            name: scenario.name.clone(),
            status: scenario_status.to_string(),
    ...
    let feature_info = FeatureInfo {
        ...
        file: Some(feature_path.to_string_lossy().to_string()),
        description: None,
    };
    
    let overall_status = if total_failed_scenarios == 0 && total_failed_steps == 0 {
        "passed".to_string()
    } else {
        "failed".to_string()
    };
    ...
    Ok(ExecutionResult {
        ...
        summary: ExecutionSummary {
            passed_scenarios: total_passed_scenarios,
            failed_scenarios: total_failed_scenarios,
            skipped_scenarios: total_skipped_scenarios,
            total_scenarios: feature.scenarios.len(),
            passed_steps: total_passed_steps,
            failed_steps: total_failed_steps,
            skipped_steps: total_skipped_steps,
            total_steps: feature.scenarios.iter().map(|s| s.steps.len()).sum(),
        },
    })
}
...
async fn main() -> anyhow::Result<()> {
    ...
    // Handle new CLI commands (most work even without browser)
    if let Some(command) = args.command {
        match command {
            Commands::ListSteps { category, search, format, output, pretty } => {
                handle_list_steps_command(category, search, &format, output, pretty).await
            ...
            Commands::Run { .. } => {
                eprintln!("Error: 'run' command requires the 'chromiumoxide-backend' feature to be enabled.");
                eprintln!("Please install with: cargo install web_spec --features chromiumoxide-backend");
                std::process::exit(1);
            }
        }
    } else {
        eprintln!("Error: chromiumoxide-backend feature is not enabled.");
        eprintln!("Please install with: cargo install web_spec --features chromiumoxide-backend");
        std::process::exit(1);
    }
}
